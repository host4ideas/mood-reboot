USE [master]
GO
/****** Object:  Database [MOODREBOOT]    Script Date: 08/03/2023 11:06:43 ******/
...
USE [MOODREBOOT]
GO
/****** Object:  Table [dbo].[CENTER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CONTENT_COURSE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[COURSE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[FILE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GROUP]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MESSAGE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_ACTION]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_CENTER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_COURSE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_GROUP]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CENTER_COURSES]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_COURSE_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_CENTER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE   PROCEDURE [dbo].[SP_CREATE_CENTER]
(@EMAIL NVARCHAR(255), @NAME NVARCHAR(50), @ADDRESS NVARCHAR(150), @TELEPHONE NVARCHAR(15), @IMAGE NVARCHAR(MAX) = NULL, @CENTERID INT OUTPUT)
AS
	--Generate new ID
	DECLARE @NEWID INT;
	...
	SET @CENTERID = @NEWID;
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_COURSE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_FILE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @FILE_ID = @FILEID;
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_GROUP]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @GROUPID = @GROUP_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_GROUP_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_MESSAGE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_USER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END CATCH
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_CENTER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_COURSE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_FILE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_GROUP]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	DELETE FROM [GROUP] WHERE GROUP_ID = @GROUP_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_GROUP_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_USER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GROUP_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_CENTER]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_COURSE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_GROUP]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_GROUP_CONTENT]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_USER_EMAIL]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_USER_IMAGE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_USER_LASTSEEN]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_USER_PASSWORD]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_USER_ROLE]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_USER_USERNAME]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_CENTERS]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_COURSES]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE UC.[USER_ID] = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_GROUPS]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_LOGIN]    Script Date: 08/03/2023 11:06:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
