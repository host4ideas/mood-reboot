USE [master]
GO
/****** Object:  Database [MOODREBOOT]    Script Date: 23/03/2023 21:48:36 ******/
...
USE [MOODREBOOT]
GO
/****** Object:  Table [dbo].[APP_FILE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[APP_USER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CENTER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CHAT_GROUP]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CHAT_MESSAGE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CONTENT_COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_ACTION]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_CENTER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USER_GROUP]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[APP_FILE]  WITH CHECK ADD  CONSTRAINT [FK_FILE_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[APP_USER] ([USER_ID])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[APP_FILE] CHECK CONSTRAINT [FK_FILE_USER]
GO
...
GO
ALTER TABLE [dbo].[CHAT_MESSAGE]  WITH CHECK ADD  CONSTRAINT [FK_MESSAGE_FILE] FOREIGN KEY([FILE_ID])
REFERENCES [dbo].[APP_FILE] ([FILE_ID])
ON DELETE SET NULL
GO
ALTER TABLE [dbo].[CHAT_MESSAGE] CHECK CONSTRAINT [FK_MESSAGE_FILE]
GO
...
GO
ALTER TABLE [dbo].[CHAT_MESSAGE]  WITH CHECK ADD  CONSTRAINT [FK_MESSAGE_USER] FOREIGN KEY([USER_ID])
REFERENCES [dbo].[APP_USER] ([USER_ID])
GO
ALTER TABLE [dbo].[CHAT_MESSAGE] CHECK CONSTRAINT [FK_MESSAGE_USER]
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CENTER_COURSES]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_COURSE_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_CENTER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @CENTERID = @NEWID;
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_FILE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @FILE_ID = @FILEID;
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_GROUP]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @GROUPID = @GROUP_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_GROUP_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_MESSAGE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_USER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END CATCH
GO
/****** Object:  StoredProcedure [dbo].[SP_CREATE_USER_COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_CENTER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_FILE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_GROUP]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	DELETE FROM CHAT_GROUP WHERE GROUP_ID = @GROUP_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_GROUP_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_DELETE_USER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_GROUP_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_CENTER]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_COURSE]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_GROUP]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_UPDATE_GROUP_CONTENT]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_CENTERS]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_COURSES]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE UC.USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_GROUPS]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_USER_LOGIN]    Script Date: 23/03/2023 21:48:36 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
