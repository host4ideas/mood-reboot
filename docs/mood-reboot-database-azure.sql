...
GO
/****** Object:  Table CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table CONTENT_COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table APP_FILE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table CHAT_GROUP    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table CHAT_MESSAGE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table APP_USER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table USER_ACTION    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table USER_CENTER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table USER_COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table USER_GROUP    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE CENTER  WITH CHECK ADD  CONSTRAINT FK_CENTER_USER FOREIGN KEY(DIRECTOR)
REFERENCES APP_USER (USER_ID)
ON DELETE SET NULL
GO
ALTER TABLE CENTER CHECK CONSTRAINT FK_CENTER_USER
GO
...
GO
ALTER TABLE APP_FILE  WITH CHECK ADD  CONSTRAINT FK_FILE_USER FOREIGN KEY(USER_ID)
REFERENCES APP_USER (USER_ID)
ON DELETE CASCADE
GO
ALTER TABLE APP_FILE CHECK CONSTRAINT FK_FILE_USER
GO
ALTER TABLE CHAT_MESSAGE  WITH CHECK ADD  CONSTRAINT FK_MESSAGE_FILE FOREIGN KEY(FILE_ID)
REFERENCES APP_FILE (FILE_ID)
ON DELETE SET NULL
GO
ALTER TABLE CHAT_MESSAGE CHECK CONSTRAINT FK_MESSAGE_FILE
GO
...
GO
ALTER TABLE CHAT_MESSAGE  WITH CHECK ADD  CONSTRAINT FK_MESSAGE_USER FOREIGN KEY(USER_ID)
REFERENCES APP_USER (USER_ID)
GO
ALTER TABLE CHAT_MESSAGE CHECK CONSTRAINT FK_MESSAGE_USER
GO
...
GO
ALTER TABLE APP_USER  WITH CHECK ADD  CONSTRAINT CK__USER__ROLE CHECK  ((ROLE='ADMIN' OR ROLE='APP_USER'))
GO
ALTER TABLE APP_USER CHECK CONSTRAINT CK__USER__ROLE
GO
/****** Object:  StoredProcedure SP_CENTER_COURSES    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_COURSE_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_CREATE_CENTER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @CENTERID = @NEWID;
GO
/****** Object:  StoredProcedure SP_CREATE_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_CREATE_COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_CREATE_FILE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @FILE_ID = @FILEID;
GO
/****** Object:  StoredProcedure SP_CREATE_GROUP    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	SET @GROUPID = @GROUP_ID;
GO
/****** Object:  StoredProcedure SP_CREATE_GROUP_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_CREATE_MESSAGE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_CREATE_USER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	END CATCH
GO
/****** Object:  StoredProcedure SP_CREATE_USER_COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_DELETE_CENTER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_DELETE_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_DELETE_COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_DELETE_FILE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_DELETE_GROUP    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	DELETE FROM CHAT_GROUP WHERE GROUP_ID = @GROUP_ID;
GO
/****** Object:  StoredProcedure SP_DELETE_GROUP_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_DELETE_USER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_GROUP_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_UPDATE_CENTER    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_UPDATE_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_UPDATE_COURSE    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_UPDATE_GROUP    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_UPDATE_GROUP_CONTENT    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_USER_CENTERS    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_USER_COURSES    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
AS
	...
	WHERE UC.USER_ID = @USER_ID;
GO
/****** Object:  StoredProcedure SP_USER_GROUPS    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure SP_USER_LOGIN    Script Date: 22/03/2023 22:27:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
