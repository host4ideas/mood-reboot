...
AS
	...
	BEGIN TRY
		...
		IF(@EXISTING_USERS = 0) BEGIN
			INSERT INTO [USER]
			VALUES(@NEW_ID, @EMAIL, HASHBYTES('SHA2_512', @PASSWORD+CAST(@salt AS NVARCHAR(36))), @USERNAME, @FIRST_NAME, @LAST_NAME, GETDATE(), @IMAGE, @ROLE, null, @salt)
...
--EXEC SP_CREATE_USER @EMAIL='example@example.com',
--@PASSWORD='admin',
--@USERNAME='adminUser',
--@FIRST_NAME='felix',
--@LAST_NAME='martinez',
